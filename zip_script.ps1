...
7z a src.zip src
7z a AMKFF_latest.zip 1DF9 1DFC asm music readme_files samples SPCs stats Visualizations Addmusic_list.txt "Addmusic_sample groups.txt" "Addmusic_sound effects.txt" addmusicMRemover.pl readme.html src.zip *.exe Makefile